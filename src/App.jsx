    ...
    interpretations: [
      {
        range: [0, 25],
        level: "Low Impact",
        text: "Stress/trauma not currently impairing leadership or relationships. Preventive coaching still valuable.",
      },
      {
        range: [26, 50],
        level: "Moderate Impact",
        text: "Noticeable effects on performance and intimacy; intervention recommended.",
      },
      {
        range: [51, 75],
        level: "High Impact",
        text: "Stress/trauma significantly undermining executive functioning and relational health; urgent support required.",
      },
      {
        range: [76, 125],
        level: "Critical Impact",
        text: "Severe dysregulation; high risk of burnout, relational breakdown, or executive collapse.",
      },
    ],
    nextStep: {
      title: "Next Step for Executives",
      description:
        "This audit is not a clinical diagnosis but a mirror. If your score suggests moderate to high impact, trauma-informed executive coaching can help you:",
      points: [
      ...
      callToAction:
        '👉 Executives: DM me "AUDIT" to schedule a confidential Executive Diagnostic Call where we\'ll unpack your results and create a tailored action plan.',
    },
  },
};
...
const QuestionCard = ({
  ...
  return (
    <div
      ref={questionRef}
      className="min-h-screen flex items-center justify-center px-3 sm:px-4 py-8 sm:py-16"
    >
    ...
    <div className="min-h-screen flex items-center justify-center px-3 sm:px-4 py-8 sm:py-16">
      <div className="w-full max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
        <div className="bg-white/95 backdrop-blur-sm p-6 sm:p-8 md:p-12 rounded-xl sm:rounded-2xl shadow-2xl border border-white/20">
          ...
          <p
            className={`text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-extrabold mb-4 sm:mb-6 ${getScoreColor(
              result.level
            )}`}
          >
            {score}/125
        ...
        <div className="bg-white/95 backdrop-blur-sm p-6 sm:p-8 md:p-12 rounded-xl sm:rounded-2xl shadow-2xl border border-white/20 text-left">
          ...
          <p className="font-semibold text-center text-gray-800 text-lg sm:text-xl">
            {nextStep.callToAction}
          </p>
        </div>
